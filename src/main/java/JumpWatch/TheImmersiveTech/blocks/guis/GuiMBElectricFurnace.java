...
public class GuiMBElectricFurnace extends GuiContainer {
    ...
    public GuiMBElectricFurnace(InventoryPlayer player, MBFurnaceTileEntity tileentity) {
        super(new ContainerMBElectricFurnace(player, tileentity));
        this.player = player;
