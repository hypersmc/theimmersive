package JumpWatch.TheImmersiveTech.Multiblock.Container;
...
public class ContainerElectricFurnaceMB extends Container {
    private final MBFurnaceTileEntity tileentity;
    private MBFurnaceController tile;
    private int cookTime, energy;
    public ContainerElectricFurnaceMB(InventoryPlayer player, MBFurnaceTileEntity tileentitiy) {
