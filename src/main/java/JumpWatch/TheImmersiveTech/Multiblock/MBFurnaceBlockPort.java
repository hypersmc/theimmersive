...
public class MBFurnaceBlockPort extends MBFurnaceBlockBase {
    ...
    public final static String INTERNAL_NAME = "mbfurnacepowerport";
    public final static String INTERNAL_NAME2 = "mbfurnaceoutputport";
    public final static String INTERNAL_NAME3 = "mbfurnaceinputport";
    public final static String INTERNAL_NAME4 = "mbfurnacefluidport";
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (tile instanceof MBFurnacePowerTileEntity) {
            return true;
        }
